...
function Certificates() {
  const certificates = [
    ...
    },
    {
      ...
      organizationName: "HackerRank",
      url: "/javascript-intermediate.pdf",
    },
    {
      title: "Python",
      organizationName: "HackerRank",
  ...
  const internships = [
    {
      ...
      location:
        "Tata Advanced Systems, Plot #C-01, 4th Floor, World Trade Tower, Sector 16, Noida Uttar Pradesh - 201301 India.",
      ...
      offerLetterUrl: "/offer-letter-tata-advance-systems-limited.pdf",
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {certificates.map((cert, index) => (
            ...
            >
              ...
              <p className="text-lg text-gray-300 dark:text-gray-700 font-bold">
      ...
      <div className="pt-12">
        ...
        {internships.map((internship, index) => (
          ...
          >
            ...
            <p className="text-lg text-white font-bold dark:text-black mb-2">
              {internship.title}
            </p>
            <p className="text-md text-gray-400 font-bold dark:text-black mb-4">
              <span className="text-yellow-200 dark:text-red-600 font-bold">
                Duration:
              </span>{" "}
              {internship.duration}
            </p>
            <p className="text-md dark:text-black font-bold text-gray-400">
              <span className="text-yellow-300 dark:text-red-600 font-bold">
                Location:
              </span>{" "}
              {internship.location}
            </p>
